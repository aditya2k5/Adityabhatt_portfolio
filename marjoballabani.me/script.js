...
╚═╝  ╚═╝╚═════╝ ╚═╝   ╚═╝      ╚═╝   ╚═╝  ╚═╝ `;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         Engineering Student • MERN Developer • Embedded Enthusiast\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
  ...
  showHelp(outputElement = this.output) {
    ...
    const utilityCommands =
      ...
      "   " +
      this.wrapWithColor("Check current weather status\n", "#ffffff") +
      this.wrapWithColor("• cv / pdf", "#98fb98") +
      "    " +
      this.wrapWithColor("Download my resume as PDF\n", "#ffffff") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "with a passion for AI integration and Embedded Systems.",
      "#ffffff"
    )}
${this.wrapWithColor(
      "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
      "   Building practical engineering solutions using ML,",
      "#ffffff"
    )}
${this.wrapWithColor("   MERN Stack, and IoT technologies.", "#ff8c00")}

${this.wrapWithColor("⚡ Projects", "#ff8c00")}
${this.wrapWithColor(
      "   Lead developer of Farmlink (AI Voice Bot) and",
      "#ffffff"
    )}
${this.wrapWithColor(
      "   innovative IoT Energy Metering systems.",
      "#ffffff"
    )}

${this.wrapWithColor("⚡ Interests", "#ff8c00")}
${this.wrapWithColor(
      "   Sustainable development, STEM outreach, and",
      "#ffffff"
    )}
${this.wrapWithColor("   building high-performance hardware/software.", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Solving real-world problems with code and circuits!",
      "#ffffff"
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">💼 Professional Experience & Internships</span>

<span style="color: #00ffff;">Live in Labs | Sustainability Strategist</span>
${this.wrapWithColor(
      "Jul 2025 | Naala, Uttarakhand",
      "#ffffff"
    )}
${this.wrapWithColor(
      "Rural Development & Infrastructure Project",
      "#98fb98"
    )}

• ${this.wrapWithColor("Project Lead", "#ffa07a")} - ${this.wrapWithColor(
      "Implemented biogas plant and water filtration systems.",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      "Community Outreach",
      ...
      "Conducted PRA and HCD studies for village development.",
      "#ffffff"
    )}

<span style="color: #00ffff;">Keltron | Industrial Training Intern</span>
${this.wrapWithColor(
      "Sept 2024 | Trivandrum, Kerala",
      "#ffffff"
    )}
• ${this.wrapWithColor("Quality Control", "#ffa07a")} - ${this.wrapWithColor(
      "Hands-on experience with industrial electronics manufacturing.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Training", "#ffa07a")} - ${this.wrapWithColor(
      "Advanced certification in C++ and Data Structures.",
      "#ffffff"
    )}

<span style="color: #00ffff;">KSEB | Technical Intern</span>
${this.wrapWithColor(
      "Aug 2024 | Kollam, Kerala",
      "#ffffff"
    )}
• ${this.wrapWithColor("Power Systems", "#ffa07a")} - ${this.wrapWithColor(
      "Studied 110kV GIS substation operations and GIS transformers.",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Bachelor of Technology in Electrical & Electronics Engg. ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
      "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Focused on AI, Embedded Systems, and Sustainable Tech ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
      "╰─────────────────────────────────────────────────────────╯",
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🛠 Technical Arsenal</span>

${this.wrapWithColor("Core Technologies", "#00ffff")}
• MERN Stack
• Machine Learning & Computer Vision
• IoT & Embedded Systems (C/Embedded C)

${this.wrapWithColor("Programming", "#00ffff")}
• Python [██████████] 95%
• C/C++  [████████░░] 85%
• JS/Web [████████░░] 80%

${this.wrapWithColor("Hardware & Tools", "#00ffff")}
• Arduino, GSM Modules, Sensors
• MATLAB, LTspice, LabVIEW
• Adobe Premiere Pro & After Effects

${this.wrapWithColor("Soft Skills", "#00ffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:adityabhattb2005@gmail.com" style="color: #ffffff; text-decoration: none;">adityabhattb2005@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://adityabhattb.me" target="_blank" style="color: #ffffff; text-decoration: none;">adityabhattb.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/aditya2k5" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/aditya2k5</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/aditya-bhatt-b-0a6593322/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/aditya-bhatt-b</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  async downloadResume() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "Preparing resume download...", "info");

    const link = document.createElement("a");
    link.href = "assets/Resume-CV_of_Aditya_Bhatt_B.pdf";
    ...
    setTimeout(() => {
      this.printToOutput(
        outputElement,
        "Resume download started! (If it fails, make sure assets/resume.pdf exists)",
        "success"
      );
    }, 1000);
  }

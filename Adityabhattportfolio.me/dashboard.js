...
class CloudDashboard {
    ...
    createSkillsCharts() {
        // Hardware & Embedded Skills Chart
        this.createSkillChart('cloudSkillsChart', {
            labels: ['Arduino', 'Embedded C', 'IoT', 'Microchip'],
            data: [95, 85, 90, 80],
        ...
        this.createSkillChart('programmingSkillsChart', {
            labels: ['C++', 'Python', 'JavaScript', 'MATLAB'],
            data: [90, 95, 85, 75],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });

        // MERN & Web Skills Chart
    ...
    initializeAllFeatures() {
        ...
        setTimeout(() => {
            this.addTypingEffect('.profile-title', 'Engineering Student & MERN Developer', 150);
        }, 2000);
    }
}
